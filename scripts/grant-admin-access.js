/**
 * Grant Super Admin and Pro Access Script (JavaScript version)
 * 
 * Usage: node scripts/grant-admin-access.js
 */

const { initializeApp } = require('firebase/app');
const { getFirestore, collection, query, where, getDocs, updateDoc, doc, setDoc, serverTimestamp } = require('firebase/firestore');
